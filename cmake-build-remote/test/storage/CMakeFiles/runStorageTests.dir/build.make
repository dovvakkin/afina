...
test/storage/CMakeFiles/runStorageTests.dir/StorageTest.cpp.o: ../test/storage/StorageTest.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.YIDWVUSsKZ/cmake-build-remote/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/storage/CMakeFiles/runStorageTests.dir/StorageTest.cpp.o"
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/storage && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/runStorageTests.dir/StorageTest.cpp.o -c /tmp/tmp.YIDWVUSsKZ/test/storage/StorageTest.cpp
...
test/storage/CMakeFiles/runStorageTests.dir/StorageTest.cpp.i: cmake_force
	...
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/storage && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.YIDWVUSsKZ/test/storage/StorageTest.cpp > CMakeFiles/runStorageTests.dir/StorageTest.cpp.i
...
test/storage/CMakeFiles/runStorageTests.dir/StorageTest.cpp.s: cmake_force
	...
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/storage && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.YIDWVUSsKZ/test/storage/StorageTest.cpp -o CMakeFiles/runStorageTests.dir/StorageTest.cpp.s
...
test/storage/runStorageTests: test/storage/CMakeFiles/runStorageTests.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.YIDWVUSsKZ/cmake-build-remote/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable runStorageTests"
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/storage && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/runStorageTests.dir/link.txt --verbose=$(VERBOSE)
...
test/storage/CMakeFiles/runStorageTests.dir/clean:
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/storage && $(CMAKE_COMMAND) -P CMakeFiles/runStorageTests.dir/cmake_clean.cmake
.PHONY : test/storage/CMakeFiles/runStorageTests.dir/clean

test/storage/CMakeFiles/runStorageTests.dir/depend:
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.YIDWVUSsKZ /tmp/tmp.YIDWVUSsKZ/test/storage /tmp/tmp.YIDWVUSsKZ/cmake-build-remote /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/storage /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/storage/CMakeFiles/runStorageTests.dir/DependInfo.cmake --color=$(COLOR)

...
test/coroutine/CMakeFiles/runCoroutineTests.dir/EngineTest.cpp.o: ../test/coroutine/EngineTest.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.YIDWVUSsKZ/cmake-build-remote/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/coroutine/CMakeFiles/runCoroutineTests.dir/EngineTest.cpp.o"
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/coroutine && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/runCoroutineTests.dir/EngineTest.cpp.o -c /tmp/tmp.YIDWVUSsKZ/test/coroutine/EngineTest.cpp
...
test/coroutine/CMakeFiles/runCoroutineTests.dir/EngineTest.cpp.i: cmake_force
	...
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/coroutine && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.YIDWVUSsKZ/test/coroutine/EngineTest.cpp > CMakeFiles/runCoroutineTests.dir/EngineTest.cpp.i
...
test/coroutine/CMakeFiles/runCoroutineTests.dir/EngineTest.cpp.s: cmake_force
	...
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/coroutine && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.YIDWVUSsKZ/test/coroutine/EngineTest.cpp -o CMakeFiles/runCoroutineTests.dir/EngineTest.cpp.s
...
test/coroutine/runCoroutineTests: test/coroutine/CMakeFiles/runCoroutineTests.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.YIDWVUSsKZ/cmake-build-remote/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable runCoroutineTests"
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/coroutine && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/runCoroutineTests.dir/link.txt --verbose=$(VERBOSE)
...
test/coroutine/CMakeFiles/runCoroutineTests.dir/clean:
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/coroutine && $(CMAKE_COMMAND) -P CMakeFiles/runCoroutineTests.dir/cmake_clean.cmake
.PHONY : test/coroutine/CMakeFiles/runCoroutineTests.dir/clean

test/coroutine/CMakeFiles/runCoroutineTests.dir/depend:
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.YIDWVUSsKZ /tmp/tmp.YIDWVUSsKZ/test/coroutine /tmp/tmp.YIDWVUSsKZ/cmake-build-remote /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/coroutine /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/coroutine/CMakeFiles/runCoroutineTests.dir/DependInfo.cmake --color=$(COLOR)

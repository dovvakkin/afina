...
test/protocol/CMakeFiles/runProtocolTests.dir/MemcachedParserTest.cpp.o: ../test/protocol/MemcachedParserTest.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.YIDWVUSsKZ/cmake-build-remote/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/protocol/CMakeFiles/runProtocolTests.dir/MemcachedParserTest.cpp.o"
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/protocol && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/runProtocolTests.dir/MemcachedParserTest.cpp.o -c /tmp/tmp.YIDWVUSsKZ/test/protocol/MemcachedParserTest.cpp
...
test/protocol/CMakeFiles/runProtocolTests.dir/MemcachedParserTest.cpp.i: cmake_force
	...
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/protocol && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.YIDWVUSsKZ/test/protocol/MemcachedParserTest.cpp > CMakeFiles/runProtocolTests.dir/MemcachedParserTest.cpp.i
...
test/protocol/CMakeFiles/runProtocolTests.dir/MemcachedParserTest.cpp.s: cmake_force
	...
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/protocol && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.YIDWVUSsKZ/test/protocol/MemcachedParserTest.cpp -o CMakeFiles/runProtocolTests.dir/MemcachedParserTest.cpp.s
...
test/protocol/runProtocolTests: test/protocol/CMakeFiles/runProtocolTests.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.YIDWVUSsKZ/cmake-build-remote/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable runProtocolTests"
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/protocol && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/runProtocolTests.dir/link.txt --verbose=$(VERBOSE)
...
test/protocol/CMakeFiles/runProtocolTests.dir/clean:
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/protocol && $(CMAKE_COMMAND) -P CMakeFiles/runProtocolTests.dir/cmake_clean.cmake
.PHONY : test/protocol/CMakeFiles/runProtocolTests.dir/clean

test/protocol/CMakeFiles/runProtocolTests.dir/depend:
	cd /tmp/tmp.YIDWVUSsKZ/cmake-build-remote && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.YIDWVUSsKZ /tmp/tmp.YIDWVUSsKZ/test/protocol /tmp/tmp.YIDWVUSsKZ/cmake-build-remote /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/protocol /tmp/tmp.YIDWVUSsKZ/cmake-build-remote/test/protocol/CMakeFiles/runProtocolTests.dir/DependInfo.cmake --color=$(COLOR)
